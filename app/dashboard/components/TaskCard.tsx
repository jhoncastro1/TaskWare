...
const statusConfig = {
    'todo': { color: 'bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border-slate-200 dark:border-slate-700', label: 'Pendiente' },
    'in-progress': { color: 'bg-blue-100 dark:bg-blue-900/40 text-blue-700 dark:text-blue-400 border-blue-200 dark:border-blue-800', label: 'En curso' },
    'review': { color: 'bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400 border-amber-200 dark:border-amber-800', label: 'Revisión' },
    'done': { color: 'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-700 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800', label: 'Completada' },
};

const priorityConfig = {
    'low': { color: 'text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/20', icon: <Clock size={18} />, label: 'Baja' },
    'medium': { color: 'text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/20', icon: <AlertCircle size={18} />, label: 'Media' },
    'high': { color: 'text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-900/20', icon: <AlertCircle size={18} />, label: 'Alta' },
};
                    ...
                    <CardFooter className="p-3 md:p-4 pt-2 md:pt-0 border-t border-border/10 mt-auto flex items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-0.5 md:gap-1 shadow-xs">
                            ...
                            <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 md:h-7 md:w-7 rounded-full hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                                onClick={() => onEdit(task)}
                            >
                                <Edit size={14} />
                            </Button>
                            <Button
                                variant="ghost"
                                size="icon"
                                className="h-8 w-8 md:h-7 md:w-7 rounded-full hover:bg-rose-50 dark:hover:bg-rose-900/30 hover:text-rose-600 dark:hover:text-rose-400 transition-colors"
